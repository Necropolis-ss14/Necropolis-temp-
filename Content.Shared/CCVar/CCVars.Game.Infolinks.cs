...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string> InfoLinksWebsite =
        CVarDef.Create("infolinks.website", "https://boosty.to/ss14necropolis", CVar.SERVER | CVar.REPLICATED); // ADT-Tweak
    ...
    public static readonly CVarDef<string> InfoLinksAppeal =
        CVarDef.Create("infolinks.appeal", "https://discord.gg/EJ939hjnsC", CVar.SERVER | CVar.REPLICATED); //ADT-Tweak: Ссылка на обжалование
